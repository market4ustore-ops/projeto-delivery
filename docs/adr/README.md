...
Status possíveis: Proposed, Accepted, Superseded, Rejected.

- [ADR-0001: Monólito modular em monorepo](0001-modular-monolith.md) — Accepted
- [ADR-0002: Dependências e ports/adapters](0002-layer-boundaries.md) — Accepted
- [ADR-0003: Isolamento multi-tenant com RLS](0003-multitenancy-rls.md) — Accepted
- [ADR-0004: Versionamento e execução de flows](0004-flow-versioning-engine.md) — Proposed
...
- [ADR-0010: Realtime de Kitchen por invalidação mínima](0010-kitchen-realtime-invalidation.md) — Proposed
